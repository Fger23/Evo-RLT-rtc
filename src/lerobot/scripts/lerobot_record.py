...
from lerobot.utils.control_utils import (
    ...
    is_headless,  # noqa: F401 - compatibility re-export
...
def record(cfg: RecordConfig) -> LeRobotDataset:
    ...
    if cfg.teleop is not None or cfg.remote_policy.training_time_rtc:
    ...
    try:
        ...
        if cfg.remote_policy.enable:
            if cfg.remote_policy.training_time_rtc:
                from lerobot.scripts.recording_trained_rtc import TrainedRTCRecordingClient

                remote_policy_client = TrainedRTCRecordingClient(
                    cfg=cfg.remote_policy, robot=robot, fps=cfg.dataset.fps, task=cfg.dataset.single_task
                )
            else:
